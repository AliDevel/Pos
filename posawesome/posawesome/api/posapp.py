...
def submit_invoice(invoice, data):
    ...
    if flt(data.get("loyalty_amount")) > 0:
        invoice_doc.loyalty_amount = invoice_doc.loyalty_amount
        invoice_doc.redeem_loyalty_points = 1
        invoice_doc.loyalty_points = invoice_doc.loyalty_points
...
def get_customer_info(customer):
    ...
    if customer.loyalty_program:
        ...
        #expense account
        res['loyalty_redemption_account'] = lp_details.get("expense_account") 
        res['loyalty_redemption_cost_center'] = lp_details.get("cost_center") 
